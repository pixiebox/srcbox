...
maxWidth:1024},{folder:"640",maxWidth:320,minDevicePixelRatio:2},{folder:"900",minWidth:320,maxWidth:667,minDevicePixelRatio:2},{folder:"2048",minWidth:414,maxWidth:736,minDevicePixelRatio:3},{folder:"2048",minWidth:748,maxWidth:1024,minDevicePixelRatio:2}]},c="object"===typeof b?a.extend(e,b):e,f,g=function k(){f--;if(!f)c.onNewNode();a.removeEvent("load",this,k)},h=function m(){f--;if(!f)c.onComplete();a.removeEvent("load",this,m)};a.setImages(this,c);a.setLazySrc();a.addEvent("scroll",window,a.setLazySrc);
a.addEvent(a.orientationEvent,window,a.debounce(function(){a.setImages(d,c)},250));"onNewNode"in c&&a.addEvent("load",window,function(){a.addEvent("DOMNodeInserted",document,a.debounce(function(){if(f=a.newItems.length)a.forEach(a.newItems,function(b,d){/[ws]*(srcbox)+[ws]*/.test(a.newItems[d].className)&&(a.setImage(a.newItems[d],c),a.addEvent("load",a.newItems[d],g))}),a.newItems.splice(0,a.newItems.length)},250));a.addEvent("DOMNodeInserted",document,a.waitForNew)});"onComplete"in c&&(f=d.length)&&
a.forEach(d,function(b,e){/[ws]*(srcbox)+[ws]*/.test(d[e].className)&&(a.setImage(d[e],c),a.addEvent("load",d[e],h))})},enumerable:!1})})();