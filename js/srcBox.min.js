...
this,g=arguments,k=a&&!e;clearTimeout(e);e=setTimeout(function(){e=null;a||b.apply(f,g)},d);k&&b.apply(f,g)}},devicePixelRatio:function(){return"devicePixelRatio"in window?window.devicePixelRatio:1},extend:function(b,d){var c={};a.forEach(b,function(d,a){c[a]=b[a]});a.forEach(d,function(b,a){c[a]=d[a]});return c},forEach:function(b,a,c){if("[object Object]"===Object.prototype.toString.call(b))for(var e in b)Object.prototype.hasOwnProperty.call(b,e)&&a.call(c,b[e],e,b);else{e=0;for(var f=b.length;e<
...
a.forEach(b,function(c,e){a.setImage(b[e],h.settings[d])}),a.addEvent("scroll",window,a.setLazySrc))},setLazySrc:function(){for(var b=a.lazyElems.length;b--;)a.inviewport(a.lazyElems[b])&&(a.lazyElems[b].src=a.lazyElems[b].getAttribute("data-lag-src"),a.lazyElems[b].removeAttribute("height"),a.lazyElems.splice(b,1))},setSrc:function(b,d){/(^|\s)lag(\s|$)/.test(b.className)?(b.setAttribute("data-lag-src",d),a.lazyElems.push(b)):"img"===b.nodeName.toLowerCase()?(b.src=d,b.removeAttribute("height")):
(b.style.backgroundImage="url("+d+")",b.style.backgroundRepeat="no-repeat")},supportsOrientationChange:function(){return"ontouchstart"in window}},h={settings:[],init:function(b,d,c){a.currentBreakpoint=0;if(document.all&&!document.addEventListener){var e=Array.prototype.slice;Array.prototype.slice=function(){if(this instanceof Array)return e.apply(this,arguments);for(var a=[],b=2<=arguments.length?arguments[1]:this.length,d=1<=arguments.length?arguments[0]:0;d<b;d++)a.push(this[d]);return a}}c=c||
document;var f=Array.prototype.slice.call(c.querySelectorAll(b));c={breakpoints:[{folder:"480",maxWidth:480},{folder:"640",minWidth:481,maxWidth:767},{folder:"900",minWidth:768,maxWidth:900},{folder:"1170",minWidth:992},{folder:"900",minWidth:748,maxWidth:1024},{folder:"640",maxWidth:320,minDevicePixelRatio:2},{folder:"900",minWidth:320,maxWidth:667,minDevicePixelRatio:2},{folder:"2048",minWidth:414,maxWidth:736,minDevicePixelRatio:3},{folder:"2048",minWidth:748,maxWidth:1024,minDevicePixelRatio:2}],
debug:!1,parentOffset:!0};c="object"===typeof d&&"breakpoints"in d?"extend"in d&&!0===d.extend?a.extend(c,d):d:a.extend(c,d);var g,k=function(){g--;if(!g)h.settings[b].onComplete()};c.defaultBreakpoint="defaultBreakpoint"in d?d.defaultBreakpoint:{folder:"1170"};h.settings[b]=c;a.selector[Object.size(a.selector)]=b;a.mergedElements[b]=f;a.setImages(f,b);a.setLazySrc();a.lazyElems.length&&a.addEvent("scroll",window,a.setLazySrc);h.settings[b].debug&&a.addEvent(a.orientationEvent(),window,a.debounce(function(){a.forEach(a.selector,
