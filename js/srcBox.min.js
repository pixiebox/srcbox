...
a.forEach(d,function(b,e){if(/[ws]*(srcbox)+[ws]*/.test(d[e].className))if(a.setImage(d[e],c),/[ws]*(lag)+[ws]*/.test(d[e].className)){if(f--,!f)c.onComplete()}else a.addEvent("load",d[e],h)})},enumerable:!1})})();